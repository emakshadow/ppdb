        ...
        <div class="col-md-12">
          <!-- general form elements -->
            <div class="card card-primary card-outline ">
              <!-- form start -->
              <form method="POST" action="<?php echo base_url('Excel/import_ketm')?>" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <!-- /.col-->
                  <div class="col-md-5">
                   <a href="<?php echo base_url("Excel/export_ketm"); ?>" class="btn btn-success" style="margin-top: 31px;">Beri Penilaian</a></h3>
                </div>
                  <!-- /.col-->
                </div>
              </div>
        ...
        <div class="col-md-12">
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                   <div class="col-md-5 mt-1">
                      Pilih Data Rekap
                      <input type="hidden" name="pilih_jalur" value="ketm">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Data Peserta Jalur KETM </h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
