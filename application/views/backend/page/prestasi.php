        ...
        <div class="col-md-12">
          <!-- general form elements -->
            <div class="card card-primary card-outline ">
              <!-- form start -->
              <form method="POST" action="<?php echo base_url('Excel/import_prestasi')?>" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <!-- /.col-->
                  <div class="col-md-5">
                   <a href="<?php echo base_url("Excel/export_prestasi"); ?>" class="btn btn-success" style="margin-top: 31px;">Beri Penilaian</a></h3>
                </div>
                  <!-- /.col-->
                </div>
              </div>
