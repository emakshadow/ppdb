...
public function export_btq(){
    ...
    $excel->getProperties()->setCreator('My Notes Code')
                 ...
                 ->setTitle("Data Peserta BTQ")
                 ->setSubject("Peserta BTQ")
                 ->setDescription("Laporan Semua Data Peserta BTQ")
                 ->setKeywords("Data Peserta BTQ");
    ...
    $excel->getActiveSheet(0)->setTitle("Laporan Data Peserta BTQ");
    $excel->setActiveSheetIndex(0);
    // Proses file excel
    header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
    header('Content-Disposition: attachment; filename="Data Peserta BTQ.xlsx"'); // Set nama file excel nya
  ...
  public function import_btq()
    {
        ...
        if (!$this->upload->do_upload()) {
            ...
            $peserta = $this->Madmin->read_btq_array();
            $data = array();
            $numrow = 4;
            foreach (array_combine($sheet, $peserta) as $row1 => $row2)
                            if($numrow > 4){
                                array_push($data, array(
                                  ...
                                  array_push($data, array(
                                    ...
                                    'asal_sekolah'      => $row2['asal_sekolah'],
                                    'no_hp'           => $row2['no_hp'],
                                    'id_status'      => $row2['id_status'],
            ...
            $this->db->update_batch('peserta', $data);
